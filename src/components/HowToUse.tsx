export default function HowToUse() {
  const steps = [
    {
      step: '01',
      title: '문의하기',
      description: '원하시는 상품권 종류와 수량을 문의해 주세요.',
      icon: (
    ...
    },
    {
      step: '02',
      title: '견적 확인',
      description: '맞춤 견적을 확인하고 주문을 확정합니다.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      step: '04',
      title: '상품권 수령',
      description: '빠르게 상품권을 받아 홍보해 보세요!',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="how-to-use" className="min-h-screen py-20 bg-gray-50 flex items-center">
